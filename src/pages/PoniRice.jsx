...
export default function PoniRice() {
  ...
  useEffect(() => {
    document.title = 'Ponni Rice-VV RiceMill';
  }, []);
  return (
    <>
    <Box className="NAV">
    <Tooltip hasArrow label='Home' bg='gray.100' color="blue.900">
      ...
      <Box mt={["100px","150px"]} ml={["20px","30px","80px","120px"]}>
          ...
          <ChevronRightIcon boxSize={5} color="red.500" /><b> Ponni Rice</b></Text>
      </Box>
        ...
        <Grid templateColumns={['repeat(1, 1fr)','repeat(2, 1fr)','repeat(1, 1fr)','repeat(2, 1fr)']} gap={[6,'','',4,]}>
          <GridItem w='100%' h='100%' >
            <Flex alignItems="center" justifyContent={["","flex-end","center","flex-end","flex-end"]} >
              <Image  src='images/ponni_rice-min_1.png' alt='Ponni Rice' ml={["","","","30px"]} height={["320px","500px"]} width={["100vw","100vw","600px","600px"]} />
            </Flex>
          </GridItem>
          <GridItem w='100%' h='100%'>
            <Box ml={["19px","","90px","50px"]}>
              <Button color="blue.900"  _hover={{ bg: 'blue.900', color: 'white' }}> In Stock</Button>
              <Heading mt="8px" color="blue.900">Ponni Rice</Heading>
              <Heading size='md' mt="8px" fontWeight="500"  color="blue.900">₹190.00 – ₹3,800.00</Heading>
              <Box height={["100%",150]} width={["90vw","","80vw",400]}alignContent="center" mt="18px">
                ...
                <List spacing={3}>
                  ...
                  Popular South Indian rice variety
                  </ListItem>
                  <ListItem>
                  <ListIcon as={CheckCircleIcon} color='green.500' />
                  Health benefits
                  ...
                  <ListItem>
                  <ListIcon as={CheckCircleIcon} color='green.500' />
                  Known for its long, slender grains
                  </ListItem>
                  <ListItem>
                  <ListIcon as={CheckCircleIcon} color='green.500' />
              ...
              <Box mt={["30px","50px"]}>
                <form action="">
                  ...
                  <Box style={{ position: "relative" }} width={["90vw","","80vw",400]} mt={["5px","7px"]}>
                    <Divider
                      position="absolute"
                      top="0"
                      left="0"
                  ...
                  <Box mt={["40px"]}>
                    ...
                    <Heading color="blue.900" as="b">₹ {count*(selectedOption*38)}.00</Heading>
                  </Box>
              </Box>
            </Box>
          </GridItem>
