...
export default function IdlyRice() {
  ...
  useEffect(() => {
    document.title = 'Idly Rice-VV RiceMill';
  }, []);
  return (
    <>
    <Tooltip hasArrow label='Home' bg='gray.100' color="blue.900">
      ...
      <Box mt={["100px","150px"]} ml={["20px","30px","80px","120px"]}>
          ...
          <ChevronRightIcon boxSize={5} color="red.500" /><b> Idly Rice</b></Text>
      </Box>
        ...
        <Grid templateColumns={['repeat(1, 1fr)','repeat(2, 1fr)','repeat(1, 1fr)','repeat(2, 1fr)']} gap={[6,'','',4,]}>
          <GridItem w='100%' h='100%' >
            <Flex alignItems="center" justifyContent={["","flex-end","center","flex-end","flex-end"]} >
              <Image  src='images/idli.webp' alt='Chengalpattu Rice' ml={["","","","30px"]} height={["320px","500px"]} width={["100vw","100vw","600px","600px"]} />
            </Flex>
          </GridItem>
          <GridItem w='100%' h='100%'>
            <Box ml={["19px","","90px","50px"]}>
              ...
              <Box mt={["25px","","45px","80px","50px"]}>
                <form action="">
                  <Flex>
                    <Box mr={["10px","20px"]}>
                    <Text color="blue.900" mb={["11px","","","25px","10px"]}><b>Quantity :</b></Text>
                    <Flex>
                    ...
                    <Box>
                      <Text color="blue.900" mb={["11px","","","25px","10px"]}><b>In Stock</b></Text>
                    ...
                    <Box mt={["33.5px","","","49px","33.5px"]} ml={["4px","10px"]}>
                  ...
                  <Box mt={["40px"]}>
                    ...
                    <Heading color="blue.900" as="b">₹ {count*(selectedOption*40)}.00</Heading>
                  </Box>
              </Box>
            </Box>
          </GridItem>
