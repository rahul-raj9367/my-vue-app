  ...
  return (
    <Box >
      ...
      <Box position="fixed" left="30px" top="130px" cursor="pointer"  zIndex="1">
        ...
        borderRadius="50%"
        bg="gray.100"
        display={["none","none","none","none","flex","flex","none"]}
        ...
        <Grid templateColumns={['repeat(1, 1fr)','repeat(2, 1fr)','repeat(1, 1fr)','repeat(2, 1fr)']} gap={[6,'','',4,]}>
          <GridItem w='100%' h='100%' >
            <Flex alignItems="center" justifyContent={["","flex-end","center","flex-end","flex-end"]} >
              <Image  src='images/chengal1.webp' alt='Chengalpattu Rice' ml={["","","","30px"]} height={["320px","500px"]} width={["100vw","100vw","600px","600px"]} />
            </Flex>
          </GridItem>
          <GridItem w='100%' h='100%'>
            <Box ml={["19px","","90px","50px"]}>
              <Button color="blue.900"  _hover={{ bg: 'blue.900', color: 'white' }}> In Stock</Button>
              <Heading mt="8px" color="blue.900">Chengalpattu Rice</Heading>
              <Heading size='md' mt="8px" fontWeight="500"  color="blue.900">₹225.00 – ₹4,500.00</Heading>
              ...
              <Box mt={["30px","65px"]}>
                <form action="">
                  ...
                  <Box style={{ position: "relative" }} width={["90vw","","80vw",400]} mt="5px">
                    <Divider
                      position="absolute"
                      top="0"
                      left="0"
                  ...
                  <Box mt={["40px"]}>
                    ...
                    <Heading color="blue.900" as="b">₹ {count*(selectedOption*45)}.00</Heading>
                  </Box>
              </Box>
            </Box>
          </GridItem>
         ...
         <Grid templateColumns={['repeat(1, 1fr)','repeat(1, 1fr)','repeat(2, 1fr)']} gap={[0,6]} >
          <GridItem w='100%' h='100%'>
            ...
            <Box ml={["10px","10px","10px","10px","120px"]}>
              ...
              category rice is best for both home consumption and commercial purpose.</Text> */}
              <List spacing={2}>
                  <ListItem>
                  <ListIcon as={CheckCircleIcon} color='green.500' />
                    Premium South Indian rice.
